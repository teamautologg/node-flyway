...
exports.getFlywayCliVersionForHash = exports.getDirectoryNameForFlywayVersion = exports.getUrlComponentsForFlywayVersion = exports.FlywayVersion = void 0;
var FlywayVersion;
(function (FlywayVersion) {
    // "V3.0.0", // Not supported
    // "V3.1.0", // Not supported
    // "V3.2.0", // Not supported
    // "V3.2.1", // Not supported
    FlywayVersion[FlywayVersion["V4.0.0"] = 0] = "V4.0.0";
    FlywayVersion[FlywayVersion["V4.0.1"] = 1] = "V4.0.1";
    FlywayVersion[FlywayVersion["V4.0.2"] = 2] = "V4.0.2";
    FlywayVersion[FlywayVersion["V4.0.3"] = 3] = "V4.0.3";
    FlywayVersion[FlywayVersion["V4.1.0"] = 4] = "V4.1.0";
    FlywayVersion[FlywayVersion["V4.1.1"] = 5] = "V4.1.1";
    FlywayVersion[FlywayVersion["V4.1.2"] = 6] = "V4.1.2";
    FlywayVersion[FlywayVersion["V4.2.0"] = 7] = "V4.2.0";
    FlywayVersion[FlywayVersion["V5.0.0"] = 8] = "V5.0.0";
    FlywayVersion[FlywayVersion["V5.0.1"] = 9] = "V5.0.1";
    FlywayVersion[FlywayVersion["V5.0.2"] = 10] = "V5.0.2";
    FlywayVersion[FlywayVersion["V5.0.3"] = 11] = "V5.0.3";
    FlywayVersion[FlywayVersion["V5.0.4"] = 12] = "V5.0.4";
    FlywayVersion[FlywayVersion["V5.0.5"] = 13] = "V5.0.5";
    FlywayVersion[FlywayVersion["V5.0.6"] = 14] = "V5.0.6";
    FlywayVersion[FlywayVersion["V5.0.7"] = 15] = "V5.0.7";
    FlywayVersion[FlywayVersion["V5.1.0"] = 16] = "V5.1.0";
    FlywayVersion[FlywayVersion["V5.1.1"] = 17] = "V5.1.1";
    FlywayVersion[FlywayVersion["V5.1.3"] = 18] = "V5.1.3";
    FlywayVersion[FlywayVersion["V5.1.4"] = 19] = "V5.1.4";
    FlywayVersion[FlywayVersion["V5.2.0"] = 20] = "V5.2.0";
    FlywayVersion[FlywayVersion["V5.2.1"] = 21] = "V5.2.1";
    FlywayVersion[FlywayVersion["V5.2.2"] = 22] = "V5.2.2";
    FlywayVersion[FlywayVersion["V5.2.3"] = 23] = "V5.2.3";
    FlywayVersion[FlywayVersion["V5.2.4"] = 24] = "V5.2.4";
    FlywayVersion[FlywayVersion["V6.0.0"] = 25] = "V6.0.0";
    FlywayVersion[FlywayVersion["V6.0.1"] = 26] = "V6.0.1";
    FlywayVersion[FlywayVersion["V6.0.2"] = 27] = "V6.0.2";
    FlywayVersion[FlywayVersion["V6.0.3"] = 28] = "V6.0.3";
    FlywayVersion[FlywayVersion["V6.0.4"] = 29] = "V6.0.4";
    FlywayVersion[FlywayVersion["V6.0.5"] = 30] = "V6.0.5";
    FlywayVersion[FlywayVersion["V6.0.6"] = 31] = "V6.0.6";
    FlywayVersion[FlywayVersion["V6.0.7"] = 32] = "V6.0.7";
    FlywayVersion[FlywayVersion["V6.0.8"] = 33] = "V6.0.8";
    FlywayVersion[FlywayVersion["V6.1.0"] = 34] = "V6.1.0";
    FlywayVersion[FlywayVersion["V6.1.1"] = 35] = "V6.1.1";
    FlywayVersion[FlywayVersion["V6.1.2"] = 36] = "V6.1.2";
    FlywayVersion[FlywayVersion["V6.1.3"] = 37] = "V6.1.3";
    FlywayVersion[FlywayVersion["V6.1.4"] = 38] = "V6.1.4";
    FlywayVersion[FlywayVersion["V6.2.0"] = 39] = "V6.2.0";
    FlywayVersion[FlywayVersion["V6.2.1"] = 40] = "V6.2.1";
    FlywayVersion[FlywayVersion["V6.2.2"] = 41] = "V6.2.2";
    FlywayVersion[FlywayVersion["V6.2.3"] = 42] = "V6.2.3";
    FlywayVersion[FlywayVersion["V6.2.4"] = 43] = "V6.2.4";
    FlywayVersion[FlywayVersion["V6.3.0"] = 44] = "V6.3.0";
    FlywayVersion[FlywayVersion["V6.3.1"] = 45] = "V6.3.1";
    FlywayVersion[FlywayVersion["V6.3.2"] = 46] = "V6.3.2";
    FlywayVersion[FlywayVersion["V6.3.3"] = 47] = "V6.3.3";
    FlywayVersion[FlywayVersion["V6.4.0"] = 48] = "V6.4.0";
    FlywayVersion[FlywayVersion["V6.4.1"] = 49] = "V6.4.1";
    FlywayVersion[FlywayVersion["V6.4.2"] = 50] = "V6.4.2";
    FlywayVersion[FlywayVersion["V6.4.3"] = 51] = "V6.4.3";
    FlywayVersion[FlywayVersion["V6.4.4"] = 52] = "V6.4.4";
    FlywayVersion[FlywayVersion["V6.5.0"] = 53] = "V6.5.0";
    FlywayVersion[FlywayVersion["V6.5.1"] = 54] = "V6.5.1";
    FlywayVersion[FlywayVersion["V6.5.2"] = 55] = "V6.5.2";
    FlywayVersion[FlywayVersion["V6.5.3"] = 56] = "V6.5.3";
    FlywayVersion[FlywayVersion["V6.5.4"] = 57] = "V6.5.4";
    FlywayVersion[FlywayVersion["V6.5.5"] = 58] = "V6.5.5";
    FlywayVersion[FlywayVersion["V6.5.6"] = 59] = "V6.5.6";
    FlywayVersion[FlywayVersion["V6.5.7"] = 60] = "V6.5.7";
    FlywayVersion[FlywayVersion["V7.0.0"] = 61] = "V7.0.0";
    FlywayVersion[FlywayVersion["V7.0.1"] = 62] = "V7.0.1";
    FlywayVersion[FlywayVersion["V7.0.2"] = 63] = "V7.0.2";
    FlywayVersion[FlywayVersion["V7.0.3"] = 64] = "V7.0.3";
    FlywayVersion[FlywayVersion["V7.0.4"] = 65] = "V7.0.4";
    FlywayVersion[FlywayVersion["V7.1.0"] = 66] = "V7.1.0";
    FlywayVersion[FlywayVersion["V7.1.1"] = 67] = "V7.1.1";
    FlywayVersion[FlywayVersion["V7.10.0"] = 68] = "V7.10.0";
    FlywayVersion[FlywayVersion["V7.11.0"] = 69] = "V7.11.0";
    FlywayVersion[FlywayVersion["V7.11.1"] = 70] = "V7.11.1";
    FlywayVersion[FlywayVersion["V7.11.2"] = 71] = "V7.11.2";
    FlywayVersion[FlywayVersion["V7.11.3"] = 72] = "V7.11.3";
    FlywayVersion[FlywayVersion["V7.11.4"] = 73] = "V7.11.4";
    FlywayVersion[FlywayVersion["V7.12.0"] = 74] = "V7.12.0";
    FlywayVersion[FlywayVersion["V7.12.1"] = 75] = "V7.12.1";
    FlywayVersion[FlywayVersion["V7.13.0"] = 76] = "V7.13.0";
    FlywayVersion[FlywayVersion["V7.14.0"] = 77] = "V7.14.0";
    FlywayVersion[FlywayVersion["V7.14.1"] = 78] = "V7.14.1";
    FlywayVersion[FlywayVersion["V7.15.0"] = 79] = "V7.15.0";
    FlywayVersion[FlywayVersion["V7.2.0"] = 80] = "V7.2.0";
    FlywayVersion[FlywayVersion["V7.2.1"] = 81] = "V7.2.1";
    FlywayVersion[FlywayVersion["V7.3.0"] = 82] = "V7.3.0";
    FlywayVersion[FlywayVersion["V7.3.1"] = 83] = "V7.3.1";
    FlywayVersion[FlywayVersion["V7.3.2"] = 84] = "V7.3.2";
    FlywayVersion[FlywayVersion["V7.4.0"] = 85] = "V7.4.0";
    FlywayVersion[FlywayVersion["V7.5.0"] = 86] = "V7.5.0";
    FlywayVersion[FlywayVersion["V7.5.1"] = 87] = "V7.5.1";
    FlywayVersion[FlywayVersion["V7.5.2"] = 88] = "V7.5.2";
    FlywayVersion[FlywayVersion["V7.5.3"] = 89] = "V7.5.3";
    FlywayVersion[FlywayVersion["V7.5.4"] = 90] = "V7.5.4";
    FlywayVersion[FlywayVersion["V7.6.0"] = 91] = "V7.6.0";
    FlywayVersion[FlywayVersion["V7.7.0"] = 92] = "V7.7.0";
    FlywayVersion[FlywayVersion["V7.7.1"] = 93] = "V7.7.1";
    FlywayVersion[FlywayVersion["V7.7.2"] = 94] = "V7.7.2";
    FlywayVersion[FlywayVersion["V7.7.3"] = 95] = "V7.7.3";
    FlywayVersion[FlywayVersion["V7.8.0"] = 96] = "V7.8.0";
    FlywayVersion[FlywayVersion["V7.8.1"] = 97] = "V7.8.1";
    FlywayVersion[FlywayVersion["V7.8.2"] = 98] = "V7.8.2";
    FlywayVersion[FlywayVersion["V7.9.0"] = 99] = "V7.9.0";
    FlywayVersion[FlywayVersion["V7.9.1"] = 100] = "V7.9.1";
    FlywayVersion[FlywayVersion["V7.9.2"] = 101] = "V7.9.2";
    FlywayVersion[FlywayVersion["V8.0.0"] = 102] = "V8.0.0";
    FlywayVersion[FlywayVersion["V8.0.1"] = 103] = "V8.0.1";
    FlywayVersion[FlywayVersion["V8.0.2"] = 104] = "V8.0.2";
    FlywayVersion[FlywayVersion["V8.0.3"] = 105] = "V8.0.3";
    FlywayVersion[FlywayVersion["V8.0.4"] = 106] = "V8.0.4";
    FlywayVersion[FlywayVersion["V8.0.5"] = 107] = "V8.0.5";
    FlywayVersion[FlywayVersion["V8.1.0"] = 108] = "V8.1.0";
    FlywayVersion[FlywayVersion["V8.2.0"] = 109] = "V8.2.0";
    FlywayVersion[FlywayVersion["V8.2.1"] = 110] = "V8.2.1";
    FlywayVersion[FlywayVersion["V8.2.2"] = 111] = "V8.2.2";
    FlywayVersion[FlywayVersion["V8.2.3"] = 112] = "V8.2.3";
    FlywayVersion[FlywayVersion["V8.3.0"] = 113] = "V8.3.0";
    FlywayVersion[FlywayVersion["V8.4.0"] = 114] = "V8.4.0";
    FlywayVersion[FlywayVersion["V8.4.1"] = 115] = "V8.4.1";
    FlywayVersion[FlywayVersion["V8.4.2"] = 116] = "V8.4.2";
    FlywayVersion[FlywayVersion["V8.4.3"] = 117] = "V8.4.3";
    FlywayVersion[FlywayVersion["V8.4.4"] = 118] = "V8.4.4";
    FlywayVersion[FlywayVersion["V8.5.0"] = 119] = "V8.5.0";
    FlywayVersion[FlywayVersion["V8.5.1"] = 120] = "V8.5.1";
    FlywayVersion[FlywayVersion["V8.5.10"] = 121] = "V8.5.10";
    FlywayVersion[FlywayVersion["V8.5.11"] = 122] = "V8.5.11";
    FlywayVersion[FlywayVersion["V8.5.12"] = 123] = "V8.5.12";
    FlywayVersion[FlywayVersion["V8.5.13"] = 124] = "V8.5.13";
    FlywayVersion[FlywayVersion["V8.5.2"] = 125] = "V8.5.2";
    FlywayVersion[FlywayVersion["V8.5.3"] = 126] = "V8.5.3";
    FlywayVersion[FlywayVersion["V8.5.4"] = 127] = "V8.5.4";
    FlywayVersion[FlywayVersion["V8.5.5"] = 128] = "V8.5.5";
    FlywayVersion[FlywayVersion["V8.5.6"] = 129] = "V8.5.6";
    FlywayVersion[FlywayVersion["V8.5.7"] = 130] = "V8.5.7";
    FlywayVersion[FlywayVersion["V8.5.8"] = 131] = "V8.5.8";
    FlywayVersion[FlywayVersion["V8.5.9"] = 132] = "V8.5.9";
    FlywayVersion[FlywayVersion["V9.0.0"] = 133] = "V9.0.0";
})(FlywayVersion = exports.FlywayVersion || (exports.FlywayVersion = {}));
const getUrlComponentsForFlywayVersion = (flywayVersion) => {
...
exports.getUrlComponentsForFlywayVersion = getUrlComponentsForFlywayVersion;
// Mapping between extracted directory name and flyway version
const getDirectoryNameForFlywayVersion = () => { };
exports.getDirectoryNameForFlywayVersion = getDirectoryNameForFlywayVersion;
// This can be improved with an object allowing a bi-directional lookup.
const getFlywayCliVersionForHash = (hash) => {
    switch (hash) {
...
exports.getFlywayCliVersionForHash = getFlywayCliVersionForHash;
//# sourceMappingURL=flyway-version.js.map